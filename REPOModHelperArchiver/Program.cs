...
namespace REPOModHelperArchiver
{
    internal static class Program
    {
        ...
        internal static string GetI18nString(string originalString, string cultureName = null)
        {
            ...
            Stream stream = Assembly.GetExecutingAssembly().GetManifestResourceStream($"REPOModHelperArchiver.I18n.{cultureName}.resources");

            // resource not found, revert to default resource
            if (null == stream)
            {
                stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("REPOModHelperArchiver.I18n.default.resources");
            }
